...
- (void) query
{
    BaasioQuery* q = [BaasioQuery queryWithCollection:@"scores"];
    [q setOrderBy:@"score" order:BaasioQuerySortOrderDESC];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    entityCell.textLabel.text = [[_data objectAtIndex:indexPath.row] objectForKey:@"nickname"];
    entityCell.detailTextLabel.text = [[[_data objectAtIndex:indexPath.row] objectForKey:@"score"] description];
    return entityCell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    detailViewController.datum = [_data objectAtIndex:indexPath.row];
